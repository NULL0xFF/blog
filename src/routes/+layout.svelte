<script>
	...
	// Children prop for layout content
	let { children } = $props();
</script>
	...
	<header class="bg-base-200">
		<div class="navbar container mx-auto">
			...
			<div class="navbar-start">
				<a href="/" class="btn btn-ghost text-xl">My Personal Blog</a>
			</div>
			...
			<div class="navbar-end">
				<label class="swap swap-rotate">
					...
					<!-- Moon icon - shows when in light mode (swap-on) -->
					<svg
					...
					<!-- Sun icon - shows when in dark mode (swap-off) -->
					<svg
